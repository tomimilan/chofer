    ...
    <form onSubmit={handleSubmit} className="mt-4 space-y-6">
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex justify-end">
            <Link
              href="/sistema-abierto/recuperar-contrasena"
              className="text-sm font-medium text-[#00334a] hover:underline"
            >
      ...
      <div className="text-center mt-4">
        <p className="text-sm text-gray-600">
          ...
          <Link href="/sistema-abierto/registro" className="font-medium text-[#00334a] hover:underline">
            Registrarse
          </Link>
        </p>
      </div>
