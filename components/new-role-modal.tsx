  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: `El rol "${formData.name}" ha sido creado correctamente. Configure los permisos en la matriz de permisos.`,
      })
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Complete la información para crear un nuevo rol. Los permisos se configurarán en la matriz de permisos.
          </DialogDescription>
        </DialogHeader>
